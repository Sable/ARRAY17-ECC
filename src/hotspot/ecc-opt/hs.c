...
/******************   LINE 20   ******************/
    ...
    for(u0=0; u0<dim0; u0++){
        p2[u0*dim1] = 0;
        for(u1=1; u1<dim1; u1++){
            p2[u0*dim1+u1] = ro2[u0*dim1+u1-1];
        }
    }
    v28.dims[0] = dim0;
    v28.dims[1] = dim1;
...
/******************   LINE 21   ******************/
    ...
    for(u0=0; u0<dim0; u0++){
        for(u1=1; u1<dim1; u1++){
            p2[u0*dim1+u1-1] = ro2[u0*dim1+u1];
        }
        p2[(u0+1)*dim1-1] = 0;
    }
    v29.dims[0] = dim0;
    ...
    for(u0=0;u0<5;u0++){
        for(u1=0; u1<5; u1++){
            printf("%lf ", p2[u0*dim1+(dim1-5+u1)]);
        }
        printf("\n");
    }
    getchar();*/
